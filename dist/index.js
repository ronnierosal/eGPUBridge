...
function App(props) {
    ...
    function showDisplaySwitchBlocked(res) {
        ...
        modalHandle = DFL.showModal(SP_REACT.createElement(DFL.ConfirmModal, {
            ...
            onOK: closeModal,
        }, e("div", { style: { fontSize: "14px", lineHeight: "20px" } }, e("p", { style: { margin: "0 0 10px", fontWeight: "700" } }, gameCount > 0
            ? (gameCount === 1 ? "A Steam game is still running." : gameCount + " Steam games are still running.")
            : "The running-game safety check did not complete."), e("p", { style: { margin: "0 0 10px" } }, detail), e("p", { style: { margin: "0" } }, "Game Mode was not restarted. Close the game, then try the display switch again."))), window, { strTitle: "eGPUBridge", bNeverPopOut: true });
    }
    ...
    e("div", { className: "egbDiagnosticNativeRow" }, e(DFL.ButtonItem, {
    ...
    }, e("div", null, "CPU: " + (diagnostics.cpu || "?")), e("div", null, "RAM: " + (diagnostics.ram_gib || diagnostics.ram || "?")), e("div", null, "GPU: " + (diagnostics.gpus ? diagnostics.gpus.length + " device(s)" : "?")), e("div", null, "ADB: " + (diagnostics.adb && diagnostics.adb.installed ? "Yes" : "No")), e("div", null, "PCIe: " + (diagnostics.pcie_link_health && diagnostics.pcie_link_health.headline
        ? diagnostics.pcie_link_health.headline
        : "Unknown")), e("div", null, "Plugin log: " +
        (diagnostics.log_errors != null ? diagnostics.log_errors : "?") + " errors · " +
        (diagnostics.log_warnings != null ? diagnostics.log_warnings : "?") + " warnings"))) : null, e("div", { className: "egbDiagnosticNativeRow" }, e(DFL.ButtonItem, {
    ...
    }, e("span", { className: "egbDiagnosticAction" }, "Check"))), e("div", { className: "egbDiagnosticNativeRow" }, e(DFL.ButtonItem, {
